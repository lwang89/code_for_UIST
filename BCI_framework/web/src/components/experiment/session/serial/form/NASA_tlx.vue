            ...
            <form @submit.prevent="submit">
                <ol>
                    <div class="form-group">
                        ...
                        <vue-slider :style="slider_style" v-model="$v.result.mental.$model" :class="{'is-invalid': $v.result.mental.$error, 'is-valid': !$v.result.mental.$invalid}" :adsorb="adsorb" :min="min" :max="max" :interval="interval" :marks="marks_low_high" :tooltip="tooltip_option">
                    ...
                    <div class="form-group">
                        ...
                        <vue-slider :style="slider_style" v-model="$v.result.performance.$model" :class="{'is-invalid': $v.result.performance.$error, 'is-valid': !$v.result.performance.$invalid}" :adsorb="adsorb" :min="min" :max="max" :interval="interval" :marks="marks_perfect_failure" :tooltip="tooltip_option">
                            <template v-slot:step="{ active }">
                                <div :class="['custom-step', { active }]"></div>
                            </template>
                        </vue-slider>
                    ...
                    <div class="form-group">
                        ...
                        <vue-slider :style="slider_style" v-model="$v.result.effort.$model" :class="{'is-invalid': $v.result.effort.$error, 'is-valid': !$v.result.effort.$invalid}" :adsorb="adsorb" :min="min" :max="max" :interval="interval" :marks="marks_low_high" :tooltip="tooltip_option">
                            <template v-slot:step="{ active }">
                                <div :class="['custom-step', { active }]"></div>
                            </template>
                        </vue-slider>
                    ...
                    <div class="form-group">
                        ...
                        <vue-slider :style="slider_style" v-model="$v.result.frustration.$model" :class="{'is-invalid': $v.result.frustration.$error, 'is-valid': !$v.result.frustration.$invalid}" :adsorb="adsorb" :min="min" :max="max" :interval="interval" :marks="marks_low_high" :tooltip="tooltip_option">
                            <template v-slot:step="{ active }">
                                <div :class="['custom-step', { active }]"></div>
                            </template>
                        </vue-slider>
...
export default {
    ...
    methods: {
        setupName() {
            ...
            this.result.name = "serial_feedback" + session_type + "_" + serial_id;
        },
        ...
        submit() {
            ...
            if (this.$v.$invalid) {
                ...
                let result = this.$store.state.serial_feedback;
